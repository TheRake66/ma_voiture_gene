<?php namespace Library\thiagoalessio\TesseractOCR;

use Library\thiagoalessio\TesseractOCR\Command;
use Library\thiagoalessio\TesseractOCR\Option;
use Library\thiagoalessio\TesseractOCR\FriendlyErrors;
